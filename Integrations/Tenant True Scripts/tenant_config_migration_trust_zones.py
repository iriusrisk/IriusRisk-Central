...
#-------------GET ALL ROLES-----------------------#
#update url
start_sub_url = '/api/v2/trust-zones'
...
post_sub_url = '/api/v2/trust-zones'
...
for item in filtered_data:
  ...
  if response.status_code==200:
    ...
    print("Request: " + response.request.method + ' ' + item['name'] + ' ' + post_url + " failed. This trust zone likely exists already\n")
